...
const CreateCampaign = () => {
  ...
  justify-center items-center flex-col rounded-[10px]
  sm:p-10 p-4"
    >
      {isLoading && <Loader />}
      ...
      >
        ...
        >
          ...
          <h4 className=" font-epilogue font-bold text-[25px] text-white ml-[20px]">
            You'll directly recive all the funds to resolve the issue
          </h4>
        </div>
        ...
        <FormField
          ...
          placeholder="place img url of the issue"
          inputType="url"
          value={form.image}
          handleChange={(e) => {
